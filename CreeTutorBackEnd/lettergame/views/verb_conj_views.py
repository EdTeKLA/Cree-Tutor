...
class VerbConjGame(View):
    ...
    def get(self, request):
        ...
        # context['level'] = level
        return render(request, 'lettergame/verbconjbuilder.html', context)

class VerbConjLevelSelect(TemplateView):
    """
    Takes in request and loads the level select template
    """
    template_name = 'lettergame/verb_conj_select_level.html'